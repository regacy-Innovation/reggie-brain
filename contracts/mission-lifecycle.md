...
The completion Slack message and the daily summary are generated from these persisted records and sent only to the permitted Slack channel. A terminal agent response without a persisted terminal record does not count as a completed mission.
